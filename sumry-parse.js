...
(function (root) {
    ...
    Parse._request = function (options) {
        ...
        if (Parse._.isUndefined(useMasterKey) && Parse._.isUndefined(sessionToken)) {
...
(function (root) {
   ...
   *   });
    ...
    Parse.Object.saveAll = function (list, options) {
        ...
        if (options && options.className === "_User") {
            options = {swessionToken: options.getSessionToken()};
        }
   ...
   *   });
     ...
     *   });
            ...
            /**
             * Set the owning user of this object for save and fetch operations.
             */
            restrict: function (user) {
                this._permission = user;
            },
            ...
            /**
             * Get the user sessionToken for save and fetch operations
             */
            permissionToken: function () {
                if (this._permission) {
                    return this._permission.getSessionToken();
                }
                return undefined;
            },
            ...
            fetch: function (options) {
                ...
                var request = Parse._request({
                    ...
                    objectId: this.id,
                    useMasterKey: options.useMasterKey,
                    sessionToken: self.permissionToken()
                });
     ...
     *   });</pre>
            ...
            save: function (arg1, arg2, arg3) {
                ...
                if (unsavedChildren.length + unsavedFiles.length > 0) {
                    return Parse.Object._deepSaveAsync(this.attributes, {
                        useMasterKey: options.useMasterKey,
                        sessionToken: model.permissionToken()
                    }).then(function () {
            ...
            destroy: function (options) {
                ...
                var request = Parse._request({
                    ...
                    method: 'DELETE',
                    useMasterKey: options.useMasterKey,
                    sessionToken: this.permissionToken()
                });
...
(function (root) {
    ...
    Parse.User = Parse.Object.extend("_User", /** @lends Parse.User.prototype */ {
        ...
        /**
         * Sets the session token for this user, if the user has been logged in,
...
(function (root) {
   ...
   * });</pre></p>
    ...
    Parse.Query.prototype = {
        ...
        /**
         * Set the user who is requesting this query
         * @param {User} The user requesing this query
         * @return {Parse.Query} Returns the query, so you can chain this call.
         */
        restrict: function (user) {
            var self = this;
        ...
        permissionToken: function (options) {
            if (this._permission) {
                return this._permission.getSessionToken() || null;
            }
            return undefined;
        },
